<template>
    <div class="navItem">
        <el-card class="search">
            ...
            <el-row>
                <el-col>
                    <el-button :style="{'margin-top':isAdmin==true?'20px':'0px'}" size="mini" @click="jumpToInsert()" type="primary" icon="el-icon-plus">添加证书颁发机构</el-button>
                </el-col>
            </el-row>
        </el-card>
        <!-- 列表 -->
        <el-card>
            ...
            'font-size': '14px',
                ...
                <el-table-column label="机构名称" width="490" style="text-align:left !important">
                ...
                <!-- <el-table-column label="颁发给" prop="code"></el-table-column> -->
                <el-table-column label="颁发者" prop="issuer" width="380"></el-table-column>
