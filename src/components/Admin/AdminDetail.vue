            ...
            <el-form ref="form" :model="form" :rules="rules" label-position="right" label-width="21%" style="margin-bottom:20px">
                <el-row :gutter="20">
                    <el-col :span="12" :offset="6">
                        <el-form-item label="用户名:" label-width="21%" prop="fullname">
                            <el-input class="inputwid" v-model="form.fullname" placeholder="请输入用户名" :disabled="isDisable"></el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="角色(多选):" label-width="21%" prop="type">
                            <el-select v-model="form.type" placeholder="请选择角色" style="width: 60%" :disabled="isDisable">
                        ...
                        <el-form-item label="确认密码:" label-width="21%" prop="password">
                            <el-input class="inputwid" v-model="form.password" prefix-icon="el-icon-lock" :type="flag1 ? 'password' : 'text'" placeholder="请输入密码" :disabled="isDisable">
                            </el-input>
                        </el-form-item>
                        ...
                        <el-form-item label="联系方式:" label-width="21%" prop="tel">
                            <el-input class="inputwid" :maxlength="11" oninput="value=value.replace(/[^\d]/g,'')" v-model="form.tel" placeholder="请输入联系方式" :disabled="isDisable"></el-input>
                        </el-form-item>
                        <el-form-item label="是否启用:" label-width="21%" prop="enable_cdp">
                            <el-switch v-model="form.enable_cdp" active-value="1" inactive-value="0" @change='switchClick($event)' active-color="#13ce66"></el-switch>
                        </el-form-item>
                        <el-form-item label="是否签发证书:" label-width="21%" prop="enable_cdp">
                            <el-switch v-model="form.enable_cdp" active-value="1" inactive-value="0" @change='switchClick($event)' active-color="#13ce66"></el-switch>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" :offset="7">
                        <el-form-item label-width="10%" style="margin-top:20px;margin-left:24px" v-if="this.YongHumode == undefined">
