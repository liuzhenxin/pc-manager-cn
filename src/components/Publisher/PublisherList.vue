    ...
    <div class="navItem">
        <el-card class="search">
            <el-row>
                <el-col :span="6">
                    ...
                    <el-input v-model="form.name" placeholder="请输入姓名" class="searchInputClass"></el-input>
                </el-col>
                <el-col :span="7">
                    <span class="titleLabel">conf:</span>
                    <el-input v-model="form.conf" placeholder="请输入conf" class="searchInputClass"></el-input>
                </el-col>

                <el-col :span="11">
                    <el-button type="warning" size="mini" style="margin-left:5px;float:right;" @click="resultList">重置</el-button>
                    <el-button type="primary" size="mini" style="margin-left:15px;float:right;" @click="getPublisherList">查询</el-button>
                </el-col>
            </el-row>
            <el-row style="margin-top:20px;margin-left:-6px;width:88%" v-if="$commonJs.getStorage().isAdmin==true">
                <el-col :span="16">
            ...
            <el-row style="margin-top:15px;">
                <el-col>
                    <el-button size="mini" @click="jumpToInsert()" type="primary" icon="el-icon-plus">添加发布者</el-button>
                </el-col>
            </el-row>
        </el-card>
        <!-- 列表 -->
        <el-card>
            ...
            'font-size': '14px',
                ...
                <el-table-column label="conf" prop="conf"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getPublisherList() {
            ...
            this.loading = true;
            this.$commonJs
                .getMethodData(this.$url.PublisherList, "POST", this.form)
                .then((res) => {
        ...
        handleDelete(row, type) {
            ...
            if (type == "删除") {
                this.$confirm("是否永久删除此条发布者?", "提示", {
                    ...
                    .then(() => {
                        this.$commonJs
                            .getMethodData(this.$url.PublisherDel, "POST", {
                                id: row.id
                            })
                            .then((res) => {
                                if (res.data.code == 100000) {
