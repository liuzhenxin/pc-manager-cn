        ...
        <div>
            ...
            <el-card class="navDetailItem" style="margin-top:10px !important">
                <div style="margin-bottom:15px;margin-top:15px">
                    <el-row>
                        <el-col :span="3">
                            <el-upload name="certKM" :disabled="form.name == ''" class="upload-demo" style="display:inline-block" :show-file-list="showFile" :headers="MyHeader" :action="actionUrl" :on-success="handleSuccess" :on-exceed="handleExceed" multiple :limit="1" :file-list="fileList">
                                <el-button :disabled="form.name == ''" style="" type="primary" size="mini" icon="l-icon-plus">上传根证书文件(.cer)</el-button>
                            </el-upload>
                        </el-col>
                        <el-col :span="15">
...
export default {
    ...
    watch: {
        "form.name"(val) {
            if (val != "") {
                this.actionUrl =
                    this.$url.ImportCertKM + "?" + "name=" + this.form.name;
            }
        },
