<template>
    <div class="navItem">
        ...
        <el-card>
            ...
            <el-table ref="multipleTable" v-loading="loading" :data="KmInfoData" tooltip-effect="dark" :header-cell-style="{
            'text-align': 'center',
            'color': '#333',
            'font-size': '14px',
                ...
                <el-table-column label="算法" prop="sigAlgName"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getrCertList() {
            ...
            this.loading = true;
            this.$commonJs
                .getMethodData(this.$url.KmInfo, "POST", this.form)
                .then((res) => {
                    if (res.data.code == 100000) {
                        this.KmInfoData = [res.data.data];
