<template>
    <div>
        <el-card class="navDetailItem">
            ...
            <router-link :to="{ path: '/RequestorList' }">
        ...
        <el-card class="intanle">
            <el-form ref="form" :model="form" :rules="rules" label-position="right" label-width="21%" style="margin-bottom:20px">
                ...
                <el-row :gutter="20">
                    ...
                    <!-- <el-col :span="12" :offset="6">
                        <el-form-item label="conf:" label-width="21%" prop="请输入conf">
...
export default {
    ...
    methods: {
        ...
        getAppDetail() {
            ...
            this.$commonJs
                .getMethodData(this.$url.RequestorById, "POST", {
                    id: this.appId
                })
                .then((res) => {
        ...
        cancel() {
            this.$router.push("/RequestorList");
        },
        ...
        onUpdate(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                ...
                if (this.mode == 3) {
                    url = this.$url.RequestorUpd;
                    this.$commonJs;
                    this.$confirm("是否修改此条请求者?", "提示", {
