        ...
        <el-card class="search">
            <el-row style="margin-left:-5px">
                ...
                <el-col :span="18">
                    ...
                    <el-button type="primary" size="mini" style="margin-left:15px;float:right;" @click="getRequestorList">查询</el-button>
                </el-col>
            </el-row>
            ...
            <el-row style="margin-top:15px;">
                <el-col>
                    <el-button size="mini" @click="jumpToInsert()" type="primary" icon="el-icon-plus">添加请求者</el-button>
                </el-col>
            </el-row>
        </el-card>
        <!-- 列表 -->
...
export default {
    ...
    methods: {
        ...
        getRequestorList() {
            this.loading = true;
            this.$commonJs
                .getMethodData(this.$url.RequestorList, "POST", this.form)
                .then((res) => {
        ...
        handleDelete(row, type) {
            ...
            if (type == "删除") {
                this.$confirm("是否永久删除此条请求者?", "提示", {
                    ...
                    .then(() => {
                        this.$commonJs
                            .getMethodData(this.$url.RequestorDel, "POST", {
                                id: row.id
                            })
                            .then((res) => {
                                if (res.data.code == 100000) {
