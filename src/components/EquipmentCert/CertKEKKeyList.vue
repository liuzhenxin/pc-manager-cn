            ...
            'font-size': '14px',
                ...
                <el-table-column label="密钥长度">
                    <template slot-scope="scope">
                        <span v-if="scope.row.SDFE_USER_KEK != undefined">
                            <span v-if="scope.row.SDFE_USER_KEK.uiKeyLen=='0'">-</span>
                            <span v-else>{{scope.row.SDFE_USER_KEK.uiKeyLen}}</span>
                        </span>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope">
                        <div v-if="scope.row.SDFE_USER_KEK != undefined">
                            <el-button @click.native.stop="addSymmetricKey(1,scope.row)" v-if="scope.row.SDFE_USER_KEK.uiKeyLen =='0'" type="text" size="mini" class="el-icon-plus" style="color: #409EFF">生成</el-button>
                            ...
                            <el-button @click.native.stop="deleteKey(scope.row)" :disabled="scope.row.SDFE_USER_KEK.uiKeyLen =='0'" type="text" size="mini" class="el-icon-delete" style="color: #da0909">销毁</el-button>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-row :gutter="20" style="margin-top:10px" v-if="isImport == '' && isImport !='2'">
                    <el-col :offset="2">
                        ...
                        <el-form-item label="密钥模长:" label-width="17%" prop="uiKeyBits">
                            <el-radio style="margin-left:10px" v-model="form.uiKeyBits" label="128">128</el-radio>
...
export default {
    ...
    methods: {
            ...
            this.$commonJs
                ...
                .then((res) => {
                    if (res.data.code == 100000) {
                        ...
                        this.symmetricKeyList = res.data.data;
                        console.log(this.symmetricKeyList, "res");
        ...
        generateKEKKey() {
            this.$commonJs
                .getMethodData(this.$url.GenerateKEKKey, "POST", this.form)
                .then((res) => {
                    if (res.data.code == 100000) {
                        console.log(res, "res");
        ...
        addSymmetricKey(type, row) {
            ...
            if (type == 1) {
                if (this.rowList.SDFE_USER_KEK.uiKeyLen != 0) {
                    this.form.uiKeyBits =
                        this.rowList.SDFE_USER_KEK.uiKeyLen.toString();
                }
            }
        },
        addKey(formName) {
            if (this.isImport == "") {
                this.$refs[formName].validate((valid) => {
                    ...
                    let keyAddName = "生成";
                    this.symmetricKeyList.forEach((item) => {
                        debugger;
                        console.log(item, "item");
                        if (item.SDFE_USER_KEK != undefined) {
                            debugger;
                            console.log(
