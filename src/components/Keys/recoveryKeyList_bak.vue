    ...
    <div class="navItem" v-loading="loading">
        <el-card>
            ...
            <el-select v-model="adminCount" placeholder="管理员数目" style="width:5%">
                <el-option :label="item" :value="item" v-for="(item,index) in adminCountList" :key="index"></el-option>
            </el-select>
                ...
                this.$commonJs
                    ...
                    .then((res) => {
                        ...
                        if (res.data.code == 100000) {
                            ...
                            if (
                                this.readCount ==
                                parseInt(this.adminCount / 2 + 1)
                            ) {
                                this.readOrNot = true
                                this.actionUrl = this.$url.RestoryKey
                            }
        ...
        addCopyKey() {
            if (this.fileStore == "") {
              ...
              if(1 === 1){
                ...
                formdata.append("shares", this.shares)
