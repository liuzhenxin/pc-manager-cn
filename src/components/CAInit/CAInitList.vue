        ...
        <el-card v-if="isSuccess == true">
            <el-row :gutter="20" style="margin-bottom:10%">
                <el-col :span="12" :offset="6">
                    <div class="fontHeader">根证书初始化</div>
                </el-col>
                <el-col :span="18" :offset="4">
                    <el-form ref="form" :model="form" label-width="300px">
                        <el-form-item label="密钥库类型:">
                            <el-select v-model="form.system_type" placeholder="请选择密钥库类型" style="width: 50%" :disabled="isDisable">
                        ...
                        <el-form-item label="密钥索引:">
                            <el-input v-model="form.newInet" placeholder="请输入密钥索引" style="width:50%"></el-input>
                        </el-form-item>
                        <el-form-item label-width="10%" style="margin-top:20px;margin-left:16.2%;">
                            <el-button style="" type="primary" size="mini" icon="l-icon-plus" @click="onUpdate">初始化根证书01</el-button>
